...
def get_output(file_number):
    ...
    for i in range(0,1):
        ...
        output += "\n"
    for i in range(0,2):
        output += word_at_positions(positions=range(2,5), case='lower')
        output += "\n"
    for i in range(0,3):
        output += word_at_positions(positions=range(5,7), case='lower')
        output += "\n"
    output += word_at_positions(positions=range(7,10), case='random')
    return output
