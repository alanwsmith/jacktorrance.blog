...
def get_output(file_number):
    output = ''
    output += word_at_positions(positions=[0,1], case='lower')
    output += "\n"
    output += word_at_positions(positions=[2,3,4], case='lower')
    output += "\n"
    output += word_at_positions(positions=[5,6], case='lower')
    output += "\n"
    output += word_at_positions(positions=[7,8,9], case='upper')
    output += "\n"
    output += word_at_positions(positions=[5,6], case='lower')
    output += "\n"
    output += word_at_positions(positions=[2,3,4], case='lower')
