...
def get_output(file_number):
    output = ''
    for i in range(0, 10):
        for x in range(0, file_number + 5):
            output += word_sets['upper_padded_5'][i] + " "
        output += "\n"
...
if __name__ == '__main__':
    ...
    word_sets['upper_padded_5'] = [x.ljust(5) for x in word_sets['upper']]
    word_sets['lower_padded_5'] = [x.ljust(5) for x in word_sets['lower']]
