...
def get_output(file_number):
    ...
    for i in range(9, -1, -1):
        ...
        removes = set()
        removes.add(i + file_number)
        removes.add(i + file_number + 1)
        removes.add(i + file_number + 2)
        removes.add(i + file_number + 3)
        removes.add(file_number - i)
        removes.add(file_number - i - 1)
        removes.add(file_number - i - 2)
        removes.add(file_number - i - 3)
        for remove in removes:
            if remove in positions:
        ...
        lines.append('ALL ' + words_at_positions(positions=positions, case='lower', spaces=None) + " DULL BOY")
    ...
    #     lines.append(words_at_positions(positions=positions, case='upper'))
